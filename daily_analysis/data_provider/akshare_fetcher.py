...
class AkshareFetcher(BaseFetcher):
    ...
    def _get_stock_realtime_quote(self, stock_code: str) -> Optional[RealtimeQuote]:
        ...
        try:
            ...
            elif (_realtime_cache.get('timestamp', 0) > 0 and
                  current_time - _realtime_cache.get('failure_timestamp', 0) < _realtime_cache.get('failure_ttl', 300)):
            ...
            _realtime_cache['failure_timestamp'] = _realtime_cache['timestamp']
            return None
