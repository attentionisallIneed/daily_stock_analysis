...
from capital_flow import CapitalFlowAdapter, CapitalFlowEvidence
...
from theme_models import LeaderCandidate, ThemeEvidence, ThemeRadarResult, ThemeSignal
    ...
    def _get_market_environment(self) -> Dict[str, Any]:
        ...
        try:
            ...
            if hasattr(self.market_analyzer, "evaluate_market_environment"):
                ...
                from market_analyzer import evaluate_market_environment
